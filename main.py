...
def main():
    ...
    theme_combo = ttk.Combobox(frame1, width=10, state="readonly", text=style.theme.name, values=style.theme_names())
    ...
    progress = ttk.Progressbar(frame7, orient='horizontal', length=434, mode='determinate')
